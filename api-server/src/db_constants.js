...
module.exports.SEQUELIZE_LOGGING =
  !!process.env.SEQUELIZE_LOGGING &&
  process.env.SEQUELIZE_LOGGING.trim().length !== 0;
...
module.exports.SQL_IS_USING_SSL = isTrueFromString(
  process.env.SQL_IS_USING_SSL,
);
