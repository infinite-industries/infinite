...
export class AnnouncementsService {
  constructor(
    @InjectModel(AnnouncementModel)
    private announcementModel: typeof AnnouncementModel,
  ) {}
  ...
  create(
    newAnnouncement: CreateOrUpdateAnnouncementRequest,
  ): Promise<AnnouncementModel> {
    const id = uuidv4();
  ...
  update(
    id: string,
    updatedAnnouncement: CreateOrUpdateAnnouncementRequest,
  ): Promise<AnnouncementModel> {
