...
exports.default = {
  ...
  methods: {
    ...
    OpenEventSubmitter: function OpenEventSubmitter() {
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"id":"example-1","toolbar":""}},[_c('v-toolbar',{staticClass:"indigo",attrs:{"dark":"","fixed":""}},[_c('v-toolbar-title',[_vm._v("Infinite Industries")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"indigo lighten-2",attrs:{"outline":""},on:{"click":function($event){$event.stopPropagation();_vm.OpenEventSubmitter()}}},[_vm._v("Submit Your Event")])],1),_vm._v(" "),_c('main',[_c('v-container',{attrs:{"fluid":""}},[_c('v-layout',{attrs:{"row":"","wrap":""}},[_vm._l((_vm.events),function(event){return [(true)?_c('v-flex',{attrs:{"sm4":"","lg3":"","event-card-container":""}},[_c('v-card',{staticStyle:{"margin-bottom":"10px","min-height":"100%"}},[_c('v-card-media',{attrs:{"src":event.image,"height":"200px"}}),_vm._v(" "),_c('v-card-title',{attrs:{"primary-title":""}},[_c('div',[_c('h3',{staticClass:"headline mb-0"},[_vm._v(_vm._s(event.title))]),_vm._v(" "),_c('div',{staticClass:"event-venue"},[_vm._v("\n                    "+_vm._s(event.venues[0])+"\n                  ")]),_vm._v(" "),_c('div',{staticClass:"event-date",domProps:{"innerHTML":_vm._s(event.when)}}),_vm._v(" "),_c('div',[_vm._v(_vm._s(event.brief_description)+"...")])])]),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"orange--text",attrs:{"flat":""},on:{"click":function($event){$event.stopPropagation();_vm.ShowEvent(event.id)}}},[_vm._v("More Info")]),_vm._v(" "),_c('span',{staticClass:"addtocalendar atc-style-blue"},[_c('var',{staticClass:"atc_event"},[_c('var',{staticClass:"atc_date_start"},[_vm._v(_vm._s(event.time_start))]),_vm._v(" "),_c('var',{staticClass:"atc_date_end"},[_vm._v(_vm._s(event.time_end))]),_vm._v(" "),_c('var',{staticClass:"atc_timezone"},[_vm._v("America/Detroit")]),_vm._v(" "),_c('var',{staticClass:"atc_title"},[_vm._v(_vm._s(event.title))]),_vm._v(" "),_c('var',{staticClass:"atc_description"},[_vm._v(_vm._s(event.brief_description))]),_vm._v(" "),_c('var',{staticClass:"atc_ical_filename"},[_vm._v(_vm._s(event.slug))]),_vm._v(" "),_c('var',{staticClass:"atc_location"},[_vm._v(_vm._s(event.venues[0]))])])])],1)],1)],1):_vm._e()]})],2)],1)],1)],1)}
